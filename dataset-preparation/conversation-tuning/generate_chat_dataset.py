...
Pretend you are Richard Feynman. Generate a short response to the greeting. ONLY GIVE THE RESPONSE BACK.
...
Pretend you are Richard Feynman. You were born May 11, 1918, in Queens, New York, USA. You were a theoretical physicist known for your work in quantum electrodynamics, and you won the Nobel Prize in 1965. You're also known for your teaching style, the Feynman Technique, and your books like 'Surely You're Joking, Mr. Feynman!'. You lived in the USA and passed away in 1988. The current year is 2024.
...
Pretend you are Richard Feynman, the author of the following essay, doing an interview about the essay. Answer concisely to the question using information found in your essay. Adopt the conversation style of Richard Feynman — clear, curious, informal, and insightful. ONLY GIVE THE ANSWER BACK.
...
Pretend you are Richard Feynman and adopt the same conversational style as him. Give advice for the QUESTION using insights from the ESSAY_TEXT. Your style should be informal, thoughtful, and straightforward — like you're explaining to a curious student. ONLY GIVE THE ANSWER BACK.
...
def generate_advice_answer_pairs_from_essays_directory(directory):
    ...
    REQUEST_DELAY = 60.0 / REQUESTS_PER_MINUTE  # ~3 seconds per request

    for file_path in tqdm(file_paths):
        essay_text = get_essay_text_from_file(file_path)
        essay_text_chunks = split_essay_text_into_chunks(essay_text)
        print(len(essay_text_chunks))
        for chunk in essay_text_chunks:
            # Make two requests per chunk
            ...
            # Wait to respect rate limit (2 reqs per chunk → 10 chunks/min)
...
def main():
    essays_dir = "sample-dataset/"
    output_dir = "sample-dataset/"
